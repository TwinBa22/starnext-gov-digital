        ...
        <div className="container-custom">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="overflow-hidden rounded-lg shadow-lg">
              <img src={hawkEyeDashboard} alt="HawkEye Monitoring Dashboard" className="w-full h-full object-cover" />
              <div className="bg-white p-6">
                <h3 className="font-semibold text-lg mb-2">Enterprise Workforce Analytics</h3>
                <p className="text-gray-600">Comprehensive device monitoring, activity tracking, and productivity insights</p>
              </div>
            </div>
          </div>
        </div>
