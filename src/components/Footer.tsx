        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/case-studies" className="text-sm text-primary-foreground/80 hover:text-secondary transition-colors">
                  Case Studies
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+918308843553" className="text-sm text-primary-foreground/80 hover:text-secondary transition-colors">
                  +91 8308843553
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={18} className="flex-shrink-0 text-secondary" />
                <a href="mailto:tanmay.halaye@starnextinnovations.com" className="text-sm text-primary-foreground/80 hover:text-secondary transition-colors">
